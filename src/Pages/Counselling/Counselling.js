...
import { FaUserGraduate, FaPhoneAlt, FaChalkboardTeacher, FaCheckCircle } from "react-icons/fa";
        ...
        <div className="page-box counselling-box">
          ...
          <div className="counselling-hero">
            <div className="counselling-hero-content">
              ...
              <p>
                Personalized guidance to help you choose the right course and college
                for a successful future. Our experts help you make confident and
                informed decisions.
              </p>
          ...
          <div className="counselling-features">
            ...
            <div className="features-grid">
              ...
              <div className="feature-card">
                ...
                <p>
                  Our certified career counsellors guide students to make the best
                  academic choices.
                </p>
              </div>
              ...
              <div className="feature-card">
                ...
                <p>
                  Understand your strengths and pick the right career path tailored
                  especially for you.
                </p>
              </div>
              ...
              <div className="feature-card">
                ...
                <h3>24/7 Support</h3>
                <p>
                  Our support team is always available to answer your queries and
                  guide you.
                </p>
              </div>
          ...
          <div className="counselling-steps">
            ...
            <div className="steps-list">
              ...
              <div className="step-card">
                ...
                <p>We understand your goals, interests, and academic background.</p>
              </div>

              <div className="step-card">
                <FaCheckCircle className="step-icon" />
                <h4>2. Course & College Mapping</h4>
                <p>We match your profile with the best possible courses and colleges.</p>
              </div>

              <div className="step-card">
                <FaCheckCircle className="step-icon" />
                <h4>3. Application Assistance</h4>
                <p>We help you with documentation, applications, and admissions.</p>
              </div>
          ...
          <div className="counselling-cta">
            ...
            <p>Speak to our expert counsellors today and get personalised guidance.</p>
